...
function MultiselectDropdown(options) {
  ...
  document.querySelectorAll("select[multiple]").forEach((el, k) => {
    ...
    el.loadOptions = () => {
      ...
      var selectedsports = document.createElement("div");
      selectedsports.setAttribute("class", "d-flex");
      ...
      div.refresh = () => {
        ...
        if (el.selectedOptions.length !== 0) {
          ...
          for (let i = 0; i < el.selectedOptions.length; i++) {
            selectedsport += `<div class="d-flex ms-1">
            <button class="form-control bg-lightgray">${el.selectedOptions[i].text}</button>
            <button class="btn btn-sm btn-success w-20 me-1" data-bs-toggle="modal"
            data-bs-target="#exampleModalCenter">Edit</button>
          </div>`;
          }

          selectedsports.innerHTML = selectedsport;
          document.getElementById("selectedsports").appendChild(selectedsports);
        }
